...
function functionSave (view) {
	...
	var save_link
	if (doc.createElementNS) save_link = doc.createElementNS("http://www.w3.org/1999/xhtml", "a");
...
var saveAs = saveAs || functionSave(typeof self !== "undefined" && self || typeof window !== "undefined" && window || this.content);

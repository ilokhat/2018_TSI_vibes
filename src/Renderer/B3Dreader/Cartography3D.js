 ...
 * define(['jquery', 'GraphicEngine', 'three', 'Cartography','lib/3DSLoader', 'ShaderL','lib/B3DLoader','lib/DDSLoader','Draw', 'Utils'],
    function($, gfxEngine, THREE, Cartography, DS3Loader, ShaderL, B3DLoader, DDSLoader, Draw, Utils) {
*/
        ...
        for(n=0;n<=nbMaterials;n+=nbTexturesInShader){
            ...
            dalleClasse.prototype.createShaderForBati = function(){
                ...
                var shaderMat = new THREE.ShaderMaterial({
                        ...
                        vertexShader:   ShaderL.shaderBati3DVS.join('\n'),//Shader.shaders['shaderBati3D.vs'],
                        fragmentShader: ShaderL.shaderBati3DFS.join('\n'),//Shader.shaders['shaderBati3D.fs'],

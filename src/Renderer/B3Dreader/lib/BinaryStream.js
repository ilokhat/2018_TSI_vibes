...
BinaryStream.prototype.size = function size() {
    return this.data.length;
};
BinaryStream.prototype.tell = function tell() {
    return this.offset;
};
BinaryStream.prototype.seek = function seek(position) {
    if (position < 0 || position >= this.data.length) return false;
    this.offset = position;
    return true;
};
BinaryStream.prototype.reset = function reset() {
    this.offset = 0;
};
BinaryStream.prototype.skip = function skip(bytesToSkip) {
...
BinaryStream.prototype.available = function available() {
    return this.data.length - this.offset;
};
BinaryStream.prototype.eof = function eof() {
    return !(this.offset < this.data.length);
};
BinaryStream.prototype.readUInt8 = function readUInt8() {
    return this.decodeInt(1, false);
};
BinaryStream.prototype.readInt8 = function readInt8() {
...
BinaryStream.prototype.readFloat32 = function readFloat32() {
    return this.decodeFloat(4, 23);
};
BinaryStream.prototype.readFloat64 = function readFloat64() {
    return this.decodeFloat(8, 52);
};
BinaryStream.prototype.readBytes = function readBytes(buffer, bytesToRead) {
...
BinaryStream.prototype.decodeInt = function decodeInt(bytes, isSigned) {
...
BinaryStream.prototype.decodeFloat = function decodeFloat(bytes, significandBits) {
    if (this.offset + bytes > this.data.length) {
        this.offset = this.data.length;
        return NaN;
    }

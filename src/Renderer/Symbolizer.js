...
Symbolizer.prototype._changeStyleEdge = function changeStyleEdge(value, folder) {
    ...
    var oldOpacity = this.edges[0].children[0].material.opacity;
    var oldColor = this.edges[0].children[0].material.color;
    var oldWidth = this.edges[0].children[0].material.linewidth;
    var i;
    var j;
    // Create new material
    var newMaterial;
